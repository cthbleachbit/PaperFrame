 ...
 * @param shortArg    optional shorthand for this argument in a single character without preceding "-", say 'r' Set to 0
 *                    i.e. NUL to indicate that this flag should not have a shorthand.
